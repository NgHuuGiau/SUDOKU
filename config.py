...
MENU_DICT = {
    "en": {
        ...
        "kho": "Hard",
        "kho_desc": "54 empty cells - True brain workout",
        "custom": "Custom",
        "custom_desc": "Target 20-60 empty cells; unique puzzles may have fewer",
    ...
    "vi": {
        ...
        "kho": "Khó",
        "kho_desc": "54 ô trống - Thử thách cao cấp",
        "custom": "Tùy chỉnh",
        "custom_desc": "Mục tiêu 20-60 ô trống; có thể ít hơn để giữ lời giải duy nhất",
        ...
        "tiep_tuc_van_desc": "Tiếp tục ván chơi đang dở ({diff} - {time})",
        "easy": "Dễ",
        "medium": "Trung bình",
        "hard": "Khó",
        "daily_challenge": "Thử thách hàng ngày",
